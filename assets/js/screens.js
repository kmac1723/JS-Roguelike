 ...
 * @Last modified time: 2018-05-12T14:07:54+01:00
 */

 // TODO: Refactor this code into seperate screen classes, and this script is just for
 //   accessing/switching between different screens.  (State Machine).

 // NOTE: Removed all references to this._map, as this is now stored in player object.
 Game.Screen = {};
...
// =================================================
 // Play screen for navigating the map.
 // NOTE: need tor efactor this into a smaller set of functions, in it's own class
 // NOTE: Removed internal _map variable
 Game.Screen.playScreen = {
     ...
     render: function(display) {
         ...
         // NOTE: Code removed into seperate renderTiles function.
         ...
         //     });
        // NOTE: Removed this code into sperate renderTIles function
...
// ==========================================
// Item list screen for use in inventory, wear, wield, etc. screens.
